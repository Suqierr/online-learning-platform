  ...
  <div class="main-content">
    <div style="width: 70%; margin: 30px auto">
      <div style="margin-bottom: 20px">
        <el-input placeholder="请输入课程名称" style="width: 200px; margin-left: 120px" size="mini" v-model="name"></el-input>
      ...
      <div class="table" style="width: 80%; margin: 30px auto">
        <el-table :data="tableData" stripe>
          <el-table-column prop="id" label="序号" width="100" align="center" sortable></el-table-column>
          <el-table-column prop="img" label="课程封面" show-overflow-tooltip width="120">
