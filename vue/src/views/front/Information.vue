    ...
    <div style="width: 70%; margin: 30px auto">
      ...
      <div class="table">
        <el-table :data="tableData" stripe>
          ...
          <el-table-column prop="img" label="资料封面" show-overflow-tooltip width="180">
            <template v-slot="scope">
              <div style="display: flex; align-items: center">
                <el-image style="width: 100px; height: 40px; border-radius: 5px; border: 1px solid #cccccc" v-if="scope.row.img"
                          :src="scope.row.img" :preview-src-list="[scope.row.img]"></el-image>
              </div>
            </template>
          </el-table-column>
          <el-table-column prop="name" label="资料名称" show-overflow-tooltip width="160">
            <template v-slot="scope">
