  ...
  <div>
    ...
    <div class="table">
      <el-table :data="tableData" stripe>
        ...
        <el-table-column prop="content" label="资料介绍" width="150">
          <template v-slot="scope">
            <el-button type="success" size="mini" style="background-color:#174b84; border-color: #174b84" @click="viewDataInit(scope.row.content)">点击查看</el-button>
          </template>
        </el-table-column>
